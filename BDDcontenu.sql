...
INSERT INTO `elementssite` (`idElement`,`contenuElement`,`cheminElement`) VALUES ('ades',' Notre entreprise compte 42 employés et est active depuis 20 ans. Nous sommes spécialisés dans les travaux de menuiserie métallique et de serrurerie. Notre activité se déploie sur trois grands pôles : la fabrication , l\'installation et la modification mais aussi l\'entretien et la maintenance. Tout ceci principalement sur les centrales nucléaires de Paluel et de Penly grâce à notre personnel habilité.','/');
...
INSERT INTO `elementssite` (`idElement`,`contenuElement`,`cheminElement`) VALUES ('edf','Depuis plus de 10 ans, nous avons les qualifications pour répondre aux appels d\'offres lancés par EDF. CADRE travaille essentiellement sur les Centrales de Penly et Paluel.','/');
...
INSERT INTO `elementssite` (`idElement`,`contenuElement`,`cheminElement`) VALUES ('histo3','En 1990 , TRAMETNOR a changé de nom pour s\'appeler CADRE qui sous sa nouvelle dénomination a poursuivi l\'activiaté commencée sur Paluel et Penly','/');
